...
func NewService(cfg *config.Config, out chan<- models.Signal, candleOut chan<- models.CandleTick) *Service {
	s := &Service{
		...
		tune: models.RuntimeTuning{
			...
			CloseUpMin:                0.70,
			CloseDnMax:                0.30,
			V3MinConfirmScore:         cfg.Strategy.V3.MinConfirmScore,
			V3RetestTolerancePct:      cfg.Strategy.V3.RetestTolerancePct,
			V3ImpulseBodyMinPct:       cfg.Strategy.V3.ImpulseBodyMinPct,
			V3CompressionThresholdPct: cfg.Strategy.V3.CompressionThresholdPct,
			V3StrongCloseMin:          cfg.Strategy.V3.StrongCloseMin,
			V3StrongCloseMax:          cfg.Strategy.V3.StrongCloseMax,
